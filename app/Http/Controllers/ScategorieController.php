...
class ScategorieController extends Controller
{
    ...
    {
        try {
            $scategories = Scategorie::with('categorie')->get(); // categorie nom de la relatiion
    ...
    public function store(Request $request)
    {
        try {
            $scategorie = new Scategorie([
                "nomscategorie" => $request->input("scategorie"),
    ...
    public function destroy($id)
    {
        try {
            ...
            $scategorie->delete();
            return response()->json("sous categorie supprimee avec succes", 200);
        } catch (\Exception $e) {
            return response()->json($e->getMessage(), 404);
        }
    }
